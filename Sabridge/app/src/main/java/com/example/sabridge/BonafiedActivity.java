...
public class BonafiedActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        actionBar.setTitle("Bonafied Form");
...
//        textView.setMovementMethod(LinkMovementMethod.getInstance());
        ...
        download.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Uri uri = Uri.parse("https://www.docdroid.net/P45BFzj/sabridge-1.pdf");
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatabaseReference reference = database.getReference("Bonafied request");
                //put data within hashmap in database
                reference.child(uid).setValue(hashMap);

                // go to profile activity
                startActivity(new Intent(BonafiedActivity.this, SubmitActivity.class));
                finish();
            } }
        });
